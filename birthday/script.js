...
typingText.forEach(typing => {
  typing.innerHTML = "";
  const splitText = typing.getAttribute('data-text').split('');
  const speedInterval = parseInt(typing.getAttribute('data-speed'));
  for(let i = 0; i < splitText.length; i++){
    setTimeout(() => {
      typing.innerHTML += splitText[i];
    }, speedInterval * i);
  }
})
